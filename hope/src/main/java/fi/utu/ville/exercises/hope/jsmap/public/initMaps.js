...
fi_utu_ville_exercises_hope_jsmap_JsMapStack = function(){
	console.log("a1");
	var vaadinView = this.getElement();
	vaadinView.innerHTML = "<div id='map'></div>";
...
function loadleaflet(that) {
	...
	$('#map').height($( document ).height() - 200);
	...
	load('VAADIN/themes/vexer-hope/world-countries.JSON', function(xhr) {
